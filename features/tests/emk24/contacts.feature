...
Feature: Проверка формы на странце контактов emk24
  ...
  Scenario Outline: контакты emk24
    ...
    Then email with "generated_test_automation_email" contains "<url>;[NAME]: test_automation_user_name;[PHONE]: +70000000000;[EMAIL]: automation.emk@gmail.com" in 240 sec
