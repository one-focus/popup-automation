...
Feature: Проверка вакансии emk24
  ...
  Scenario Outline: emk24
    ...
    When enter "test_automation_user_name_vacancy" in name field
    ...
    Then email with "generated_test_automation_email_vacancy" contains "<url>;Отклик на вакансию;[NAME]: test_automation;[PHONE]: +70000000000;[EMAIL]: automation.emk@gmail.com" in 240 sec
