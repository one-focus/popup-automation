...
Feature: Проверка кнопки Заказать в 1 клик emk24
  ...
  Scenario Outline: emk24
    ...
    Then email with "generated_test_automation_email_order_1_click" contains "<url>;Заказ в 1 клик!;test_automation_user_name;test_company_name;+70000000000;automation.emk@gmail.com" in 480 sec
