...
Feature: Проверка кнопки Купить в 1 клик
  ...
  Scenario Outline: Купить в 1 клик emk24
    ...
    Then email with "generated_comment_1_click" contains "Заказ в 1 клик!;[NAME]: test_automation_contact_name;[PHONE]: +70000000000;[EMAIL]: automation.emk@gmail.com" in 480 sec
