...
Feature: Проверка Заказ сплава emk24
  ...
  Scenario Outline: Заказ сплава emk24
    ...
    When enter "generated_test_automation_email" in name field
    ...
    Then email with "generated_test_automation_email" contains "<url>;Обратный звонок (заявка) wiki;[PHONE]: +70000000000;[EMAIL]: automation.emk@gmail.com"" in 240 sec
