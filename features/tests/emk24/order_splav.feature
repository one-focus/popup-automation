...
Feature: Проверка Заказ сплава emk24
  ...
  Scenario Outline: Заказ сплава emk24
    ...
    When enter "generated_automation_user_name" in name field
    ...
    Then email with "generated_automation_user_name" contains "<url>;Обратный звонок (заявка) wiki;[PHONE]: +70000000000;[EMAIL]: automation.emk@gmail.com"
