...
Feature: Проверка сайта railws.com
  ...
  Scenario: railws.com заказать звонок
    ...
    Then email with "generated_test_automation_email_order_railws" contains "Телефон : +7 900 000 00 00" in 480 sec
  ...
  Scenario Outline: railws.com оставить заявку
    ...
    Then email with "generated_test_automation_email_leave_call" contains "Email : automation.emk@gmail.com;Телефон : +7 900 000 00 00;Комментарий : test_automation_comment" in 480 sec
