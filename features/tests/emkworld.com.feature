...
#    Then text "Thank you for your message" is displayed
    Then email with "generated_test_automation_email_call_order" contains "+70000000000;Тема: Request from test_automation_company_name;Please, call me back +70000000000" in 240 sec
...
#    Then text "Thank you for your message" is displayed
    Then email with "generated_test_automation_email_leave_order_emk" contains "+70000000000;Тема: Request from test_automation_company_name" in 240 sec
...
#    Then text "Thank you for your message" is displayed
    Then email with "generated_test_automation_email_cont" contains "+70000000000;Тема: Request from test_automation_company_name;Please, call me back +70000000000" in 240 sec
