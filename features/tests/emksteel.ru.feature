...
Feature: Проверка сайта emksteel.ru
  ...
  Scenario Outline: emksteel.ru заказать звонок
    ...
    Then email with "generated_test_automation_email" contains "Запрос звонка emksteel.ru test_automation_company;Пожалуйста, перезвоните мне;[PHONE]: +7 (000) 000-00-00"
  ...
  Scenario: emksteel.ru оставить заявку
    ...
    Then email with "generated_test_automation_email" contains "Тема: Запрос от test_automation_company_name;[PHONE]: +7 (000) 000-00-00;[EMAIL]: automation.emk@gmail.com;[BODY]: test_automation_comment"
